...
#[cfg(feature = "custom")]
/// Appends optional parameters to OTP uris. Mutates the string in place. The URI generated by
/// this module's `otp_uri` function is usually sufficient, however if you need to fully
/// customize your OTP uri you may choose to do so with this function.
/// #### Warning!
